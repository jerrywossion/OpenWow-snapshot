...
void ChatFrame_DisplayMessage(const ObjectManager& objects, const char *message,
  ...
  switch (chat_type) {
    ...
    case static_cast<int>(ChatMsg::kMonsterWhisper):
    case static_cast<int>(ChatMsg::kMonsterEmote):
    case static_cast<int>(ChatMsg::kBgSystemNeutral):
    case static_cast<int>(ChatMsg::kBgSystemAlliance):
    case static_cast<int>(ChatMsg::kBgSystemHorde):
    case static_cast<int>(ChatMsg::kRaidBossEmote):
