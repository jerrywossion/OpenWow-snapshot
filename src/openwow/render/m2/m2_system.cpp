...
M2ResultStatus M2System::SetAnimationSample(std::uint32_t id, std::uint32_t animation, std::uint32_t time, float speed, bool zero_blend, bool restart) { return state_->animation_runtime.SetAnimationSample(id, animation, time, speed, zero_blend, restart); }
...
M2ResultStatus M2System::SetAnimationSlotSample(std::uint32_t id, std::uint32_t slot, std::uint32_t animation, std::uint32_t time, float speed, bool zero_blend, bool restart) { return state_->animation_runtime.SetAnimationSlotSample(id, slot, animation, time, speed, zero_blend, restart); }
